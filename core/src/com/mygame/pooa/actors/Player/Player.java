...
public class Player extends Entity {
    ...
    public Player(World world, Vector2 position, Vector2 size) {
        ...
        joystick = new Controller(this, velocity);
        ...
        bodyDef2.position.set(Gdx.graphics.getWidth() / PlayScreen.PPM, Gdx.graphics.getHeight() / PlayScreen.PPM * 2);
        ...
        RopeJointDef jointDef = CreateJoin.Rope(body, body2, Gdx.graphics.getHeight() / PlayScreen.PPM * 2);
